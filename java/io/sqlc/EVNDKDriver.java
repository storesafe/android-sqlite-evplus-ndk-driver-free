...
public class EVNDKDriver {
  ...
  public static final int SQLC_NULL_HANDLE = 0;
  ...
  /** Interface to C language function: <br> <code> sqlc_handle_t sqlc_ev_db_open(sqlc_handle_t dboc, const char *  filename, int flags); </code>    */
  public static native long sqlc_ev_db_open(long dboc, String filename, int flags);

  /** Interface to C language function: <br> <code> int sqlc_ev_db_open_result(sqlc_handle_t dboc); </code>    */
  public static native int sqlc_ev_db_open_result(long dboc);

  /** Interface to C language function: <br> <code> void sqlc_ev_dboc_finalize(sqlc_handle_t dboc); </code>    */
  public static native void sqlc_ev_dboc_finalize(long dboc);
  ...
  /** Interface to C language function: <br> <code> sqlc_handle_t sqlc_new_ev_dboc(); </code>    */
  public static native long sqlc_new_ev_dboc();


} // end of class EVNDKDriver
