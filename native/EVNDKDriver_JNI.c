/* !---- DO NOT EDIT: This file autogenerated by com/jogamp/gluegen/JavaEmitter.java on Tue May 04 12:12:04 EDT 2021 ----! */
 ...
 */
JNIEXPORT jlong JNICALL
Java_io_sqlc_EVNDKDriver_sqlc_1evplus_1db_1new_1qc__J(JNIEnv *env, jclass _unused, jlong db) {
  sqlc_handle_t _res;
 ...
 */
JNIEXPORT jstring JNICALL
Java_io_sqlc_EVNDKDriver_sqlc_1evplus_1qc_1execute__JLjava_lang_String_2(JNIEnv *env, jclass _unused, jlong qc, jstring batch_json) {
 ...
 */
JNIEXPORT void JNICALL
Java_io_sqlc_EVNDKDriver_sqlc_1evplus_1qc_1finalize__J(JNIEnv *env, jclass _unused, jlong qc) {
...
/*   Java->C glue code:
 *   Java package: io.sqlc.EVNDKDriver
 *    Java method: long sqlc_new_ev_dboc()
 *     C function: sqlc_handle_t sqlc_new_ev_dboc();
 */
JNIEXPORT jlong JNICALL
Java_io_sqlc_EVNDKDriver_sqlc_1new_1ev_1dboc__(JNIEnv *env, jclass _unused) {
  sqlc_handle_t _res;
  _res = sqlc_new_ev_dboc();
  return _res;
}
